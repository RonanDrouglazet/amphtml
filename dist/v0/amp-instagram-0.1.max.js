...
var AmpInstagram = (function (_AMP$BaseElement) {
  ...
  AmpInstagram.prototype.preconnectCallback = function preconnectCallback(onLayout) {
  ...
  AmpInstagram.prototype.layoutCallback = function layoutCallback() {
    ...
    var shortcode = AMP.assert(this.element.getAttribute('data-shortcode') || this.element.getAttribute('shortcode'), 'The data-shortcode attribute is required for <amp-instagram> %s', this.element);
    // See
    // https://instagram.com/developer/embedding/?hl=en
    var iframe = document.createElement('iframe');
    iframe.setAttribute('frameborder', '0');
    iframe.setAttribute('allowtransparency', 'true');
    iframe.src = 'https://instagram.com/p/' + encodeURIComponent(shortcode) + '/embed/?v=4';
