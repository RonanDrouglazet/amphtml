...
var AmpAudio = (function (_AMP$BaseElement) {
  ...
  AmpAudio.prototype.layoutCallback = function layoutCallback() {
    ...
    this.audio_ = audio;
    return _srcEventHelper.loadPromise(audio);
  };

  /** @override */

  AmpAudio.prototype.documentInactiveCallback = function documentInactiveCallback() {
    if (this.audio_) {
      this.audio_.pause();
    }
...
},{"../../../src/event-helper":3,"../../../src/layout":4,"../../../src/url":6}],2:[function(require,module,exports){
exports.__esModule = true;
