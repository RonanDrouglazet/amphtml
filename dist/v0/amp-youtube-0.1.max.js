...
var AmpYoutube = (function (_AMP$BaseElement) {
  ...
  AmpYoutube.prototype.preconnectCallback = function preconnectCallback(onLayout) {
  ...
  AmpYoutube.prototype.layoutCallback = function layoutCallback() {
    ...
    var videoid = AMP.assert(this.element.getAttribute('data-videoid') || this.element.getAttribute('video-id'), 'The data-videoid attribute is required for <amp-youtube> %s', this.element);
    // See
  ...
  AmpYoutube.prototype.documentInactiveCallback = function documentInactiveCallback() {
