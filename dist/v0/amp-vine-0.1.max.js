...
var AmpVine = (function (_AMP$BaseElement) {
  ...
  AmpVine.prototype.layoutCallback = function layoutCallback() {
    var vineid = AMP.assert(this.element.getAttribute('data-vineid'), 'The data-vineid attribute is required for <amp-vine> %s', this.element);
  ...
  AmpVine.prototype.documentInactiveCallback = function documentInactiveCallback() {
