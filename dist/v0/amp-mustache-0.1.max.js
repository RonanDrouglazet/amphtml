...
var AmpMustache = (function (_AMP$BaseTemplate) {
  ...
  AmpMustache.prototype.isExperimentOn_ = function isExperimentOn_() {
  ...
  AmpMustache.prototype.render = function render(data) {
    if (!this.isExperimentOn_()) {
      var m = 'Experiment "' + EXPERIMENT + '" disabled';
      _srcLog.log.warn(TAG, m, this.element);
    ...
    var root = this.getWin().document.createElement('div');
...
},{"../../../src/experiments":5,"../../../src/log":6,"../../../src/sanitizer":8,"../../../third_party/mustache/mustache":12}],2:[function(require,module,exports){
...
},{"./cookies":4,"./timer":9}],6:[function(require,module,exports){
exports.__esModule = true;
/**
 * Copyright 2015 The AMP HTML Authors. All Rights Reserved.
 *
...
},{"./url":10,"_process":2}],8:[function(require,module,exports){
exports.__esModule = true;
  ...
  var parser = _third_partyCajaHtmlSanitizer.htmlSanitizer.makeSaxParser({
    'startTag': function (tagName, attribs) {
      ...
      for (var i = 0; i < attribs.length; i += 2) {
        ...
        emit('="');
        if (attrValue) {
          emit(_third_partyCajaHtmlSanitizer.htmlSanitizer.escapeAttrib(attrValue));
        }
        emit('"');
      }
      emit('>');
...
function isValidAttr(attrName, attrValue) {
...
},{"../third_party/caja/html-sanitizer":11}],9:[function(require,module,exports){
exports.__esModule = true;
/**
 * Copyright 2015 The AMP HTML Authors. All Rights Reserved.
 *
